...
@Component({
  ...
  selector: 'ActualAccomplishments',
  template: `
    <div class="flex flex-col gap-2">
      <div class="flex items-center justify-between ">
        <h1 class="text-[20px] text-base-content">Actual Accomplishments</h1>
      </div>
...
// todo: refactor these components: reduce redundancy
export class ActualAccomplishmentsComponent {
  inputField = '';
